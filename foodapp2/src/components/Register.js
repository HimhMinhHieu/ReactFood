...
const Register = () => {
    ...
    const register = (evt) => {
        ...
        if (user.matKhau === user.confirmPass)
            process();
        else {
    ...
    return <>
        ...
        <Form onSubmit={register}>
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control value={user.username} onChange={(e) => change(e, "taiKhoan")} type="text" placeholder="Tên đăng nhập" required />
            </Form.Group>
            <Form.Group className="mb-3">
                <Form.Label>Mật khẩu</Form.Label>
                <Form.Control value={user.password} onChange={(e) => change(e, "matKhau")} type="password" placeholder="Mật khẩu" required />
            </Form.Group>
            <Form.Group className="mb-3">
